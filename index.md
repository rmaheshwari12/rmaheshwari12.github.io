...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
	...
	<a href="#portfolio" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> RESUME</a>
...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <p class="w3-center"><em>I love Data</em></p>
  <p>If you are looking for someone, who admire the use of technology, has proven competency to solve business problems with the aid of data-driven decisions, and a keen interest in marketing and customer experience analytics, I believe you have reached the right person !
  </p>
  <div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <p><b><i class="fa fa-user w3-margin-right"></i>Rushikesh Maheshwari</b></p><br>
      <img src="../../static/images/me.jpg" class="w3-round w3-image w3-opacity w3-hover-opacity-off" alt="Photo of Me" width="500" height="333">
    </div>
